...
-- ========== CONFIG ==========
local TOOL_NAMES = {"Bat","Medusa's Head","Quantum Cloner","Boogie Bomb"}      -- default list (will be shown in TextBox)
local SPAM_DELAY = 0.20                 -- seconds (live-editable)
local MIN_DELAY = 0.01                  -- minimum allowed delay
